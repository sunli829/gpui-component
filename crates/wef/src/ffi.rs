...
pub(crate) struct CAppCallbacks {
    pub(crate) on_schedule_message_pump_work: extern "C" fn(*mut c_void, i64),
}
...
pub(crate) struct CBrowserCallbacks {
    ...
    pub(crate) on_popup_position: extern "C" fn(*mut c_void, *const Rect),
    ...
    pub(crate) on_ime_composition_range_changed: extern "C" fn(*mut c_void, *const Rect),
    ...
    pub(crate) on_find_result: extern "C" fn(*mut c_void, i32, i32, *const Rect, i32, bool),
...
unsafe extern "C" {
    ...
    pub(crate) unsafe fn wef_do_message_loop_work();
    ...
    pub(crate) unsafe fn wef_dirty_rects_get(dirty_rects: *const c_void, i: i32, rect: *mut Rect);
    ...
    pub(crate) unsafe fn wef_cursor_info_hotspot(info: *const wef_cursor_info_t, point: *mut Point);
    ...
    pub(crate) unsafe fn wef_cursor_info_size(info: *const wef_cursor_info_t, size: *mut Size);
