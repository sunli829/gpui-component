...
pub(crate) struct WebViewElement {
    ...
    popup_image: Option<(Rect, Arc<RenderImage>)>,
}
    ...
    fn paint(
        ...
        self.interactivity.paint(
            ...
            |_, window, _cx| {
                ...
                self.browser.resize(
                    (bounds.size.width.0 * scale_factor) as u32,
                    (bounds.size.height.0 * scale_factor) as u32,
                );
        ...
        window.set_cursor_style(cursor_style, None);
        ...
        window.on_mouse_event({
            ...
            move |event: &MouseMoveEvent, phase, _, cx| {
                    ...
                    && (event.dragging() || bounds.contains(&event.position))
                {
                    ...
                    webview
                        .browser()
                        .send_mouse_move_event(position.x.0 as i32, position.y.0 as i32);
                }
            }
        });
